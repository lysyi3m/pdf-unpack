...
copy, change and redistribute the code. It gives no right to use the "PDF Unpack" name or the app
icon to identify another app.

- **Name.** Do not name or brand another app, including a fork, "PDF Unpack", so that nobody mistakes
  it for this one.
